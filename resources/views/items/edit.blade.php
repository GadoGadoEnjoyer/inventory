...
<div class="container mt-4">
    <div class="card shadow-lg" style="background-image: url('https://source.unsplash.com/random/1600x900?office'); background-size: cover; background-position: center;">
        ...
        <div class="card-body bg-light bg-opacity-75">
            ...
            <form action="{{ route('items.update', $item->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="quantity" id="quantity" class="form-control form-control-lg" value="{{ old('quantity', $item->quantity) }}" required>
                </div>

                <div class="mb-3">
                    <label for="brand" class="form-label text-dark">Brand:</label>
                    <input type="text" name="brand" id="brand" class="form-control form-control-lg" value="{{ old('brand', $item->brand) }}">
                </div>
